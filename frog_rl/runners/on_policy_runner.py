...
class OnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device: str = "cpu") -> None:
        ...
        default_sets = ["critic"]
        if self.alg_cfg["class_name"] == "AMPPPO" or self.alg_cfg.get("amp_cfg") is not None:
    ...
    def load(self, path: str, load_optimizer: bool = True, map_location: str | None = None) -> dict:
        ...
        resumed_training = self.alg.load(loaded_dict, load_optimizer=load_optimizer)
        if resumed_training:
    ...
    def _construct_algorithm(self, obs: TensorDict) -> PPO:
        ...
        if hasattr(alg_class, "construct_algorithm"):
            return alg_class.construct_algorithm(obs, self.env, self.cfg, self.device, self.multi_gpu_cfg)
