...
from frog_rl.extensions import RandomNetworkDistillation, Symmetry, resolve_rnd_config, resolve_symmetry_config
from frog_rl.models import MLPModel
from frog_rl.storage import RolloutStorage
from frog_rl.utils import compile_model, resolve_callable, resolve_obs_groups, resolve_optimizer
...
class PPO:
    ...
    def compile(self, mode: str | None = None) -> None:
        ...
        See :func:`~frog_rl.utils.compile_model` for the set of accepted modes.
