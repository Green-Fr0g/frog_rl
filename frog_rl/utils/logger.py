...
import frog_rl
from frog_rl.utils.log_writer import LogWriter
from frog_rl.utils.utils import resolve_callable
...
class Logger:
    ...
    def init_logging_writer(self) -> None:
        ...
        .. note::
            ...
            any additional constructor kwargs (see :class:`~frog_rl.utils.LogWriter`). The plain string aliases
